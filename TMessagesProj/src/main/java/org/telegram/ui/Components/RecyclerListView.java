...
//        drawSectionsBackgrounds(canvas);
    ...
    public void setSections() {
        setSections(dp(16), dp(16), false);
    }
    public void setSections(boolean topPadding) {
        setSections(dp(16), dp(16), topPadding);
    }
...
//        }
            ...
            if (isSectionItem.run(view)) {
                ...
                if (viewHolder != null && adapter != null) {
                    ...
                    if (position != RecyclerView.NO_POSITION) {
                        ...
                        if (first) outRect.top = enableTopPadding ? padding : dp(8);
                        if (last) outRect.bottom = dp(8);
                    }
                }
            }
        }
    ...
    public void setUseMD3SettingsStyle(boolean value) {
        useMD3SettingsStyle = value;
        md3SettingsStyleExplicitlySet = true;
    }

    public boolean getUseMD3SettingsStyle() {
        return useMD3SettingsStyle;
    }
    ...
    public static void drawBackgroundRect(Canvas canvas, RectF rect, float topRadius, float bottomRadius, float alpha, Theme.ResourcesProvider resourcesProvider) {
        sectionBackgroundStrokePaint.setShadowLayer(dpf2(2), 0, dpf2(1), multAlpha(0x1f000000, alpha));
        sectionBackgroundStrokePaint.setColor(0);
        sectionBackgroundPaint.setShadowLayer(dpf2(2), 0, dpf2(1), multAlpha(0x14000000, alpha));
        boolean isDark = Theme.isCurrentThemeDark();
        int cardColor = isDark ? 0xFF2B2B2B : 0xFFFFFFFF;
        sectionBackgroundPaint.setColor(multAlpha(cardColor, alpha));
